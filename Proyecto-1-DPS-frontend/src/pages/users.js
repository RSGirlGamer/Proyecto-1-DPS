...
function Users() {
    ...
    // Manejo de la visualizacion del modal para editar usuario
    const handleShow = (user) => {
        setUser(user)
        setShow(true)
    };

    // Manejo de la visualización del modal para eliminar usuario
    ...
    // Mutación para editar el rol de un usuario
    ...
    // Mutación para editar la contraseña de un usuario
