import { Button, Card, Col, Container, Form, FormGroup, InputGroup, Modal, Pagination, Row, Spinner, Table, Toast, ToastContainer } from "react-bootstrap";
            ...
            <Modal centered show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <Form>
                        ...
                        <Row>
                            <Col>
                                <FormGroup controlid="form.ControlRol">
                                    ...
                                    }} options={roles} value={{value: user?.rol_id, label: user?.user_role} || {value: '', label: ''}} onChange={e => setUser({...user, rol_id: e.value, user_role: e.label})} />
                                </FormGroup>
                        ...
                        <Row>
                            <Col>
                                <Form.Group className="mb-3" controlid="form.ControlCreatedAt">
                                    <Form.Label>Creado en</Form.Label>
                                    <Form.Control value={user.creado_en ? new Intl.DateTimeFormat('en-US', {year: 'numeric', month: '2-digit',day: '2-digit'}).format(new Date(user.creado_en)) : ""} disabled placeholder="10/08/2024" />
                                </Form.Group>
                            </Col>
                            <Col>
                                <Form.Group className="mb-3" controlid="form.ControlUpdatedAt">
                                    <Form.Label>Actualizado en</Form.Label>
                                    <Form.Control value={user.actualizado_en ? new Intl.DateTimeFormat('en-US', {year: 'numeric', month: '2-digit',day: '2-digit'}).format(new Date(user.actualizado_en)) : ""} disabled placeholder="10/08/2024" />
                                </Form.Group>
                            </Col>
                        </Row>
                    </Form>
